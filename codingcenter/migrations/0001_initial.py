# Generated by Django 2.1.4 on 2019-03-12 06:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(related_name='assignments', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='College',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='results', to='codingcenter.Question')),
        ...
        migrations.AddField(
            model_name='question',
            name='participants',
            field=models.ManyToManyField(through='codingcenter.Result', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='user',
            name='questions',
            field=models.ManyToManyField(through='codingcenter.Result', to='codingcenter.Question'),
        ),
    ]
